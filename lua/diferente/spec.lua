  ...
  vim.api.nvim_create_autocmd("WinClosed", {
    ...
    callback = function(event)
      ...
      for _, bufnr in ipairs(vim.api.nvim_list_bufs()) do
        ...
        if name ~= "" then table.insert(open_bufs, name) end
      end

      -- Get expected diferente named buffers
      local diferente_buffers = vim.tbl_map(
        function(value) return vim.fn.getcwd() .. "/" .. value end,
        { "DiferenteDiff", "DiferenteGitLog", "DiferenteGitStatus" }
      )
      ...
      if vim.deep_equal(open_bufs, diferente_buffers) then vim.cmd("quitall!") end
      ...
      vim.tbl_map(
        function(value) vim.cmd("bw " .. value) end,
        { "DiferenteDiff", "DiferenteGitLog", "DiferenteGitStatus" }
      )
    end,
  })
...
M.init = function(opts)
  ...
  vim.api.nvim_create_autocmd({ "BufWinEnter" }, {
    ...
    callback = function() Diferente(opts) end,
  })
end
